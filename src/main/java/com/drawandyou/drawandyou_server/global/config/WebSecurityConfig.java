...
import com.drawandyou.drawandyou_server.global.security.JwtAuthenticationFilter;
import com.drawandyou.drawandyou_server.global.security.OAuthSuccessHandler;
import com.drawandyou.drawandyou_server.global.security.RedirectUrlCookieFilter;
import com.drawandyou.drawandyou_server.global.security.application.service.CustomOAuth2UserService;
...
public class WebSecurityConfig {
    ...
    // oauth2 로그인 성공시 동작할 핸들러
    private final OAuthSuccessHandler oAuthSuccessHandler;

    // 리다이렉트 url 정보를 쿠키에 저장하는 필터
    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .oauth2Login(oauth2-> oauth2
                        .userInfoEndpoint(userInfo -> userInfo.userService(customOAuth2UserService)) // oauth2 사용자 정보 로딩
    ...
    CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(
                Arrays.asList("http://localhost:3000" , "https://www.drawandyou.com")
        );
